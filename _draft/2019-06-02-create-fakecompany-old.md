...
header:
  teaser: "/assets/images/Posts/2019-06-02-create-fakecompany/logo-fakecompany.png"
  og_image: "/assets/images/Posts/2019-06-02-create-fakecompany/logo-fakecompany.png"
type: posts
classes: wide
comments: true
read_time: true
...
<p style="text-align: justify;"><img src="{{ site.baseurl }}/assets/images/Posts/2019-06-02-create-fakecompany/logo-fakecompany.png" class="align-left">
While fessing tests in my lab, I got tired of creating users User01 groups, etc ... So I decided to create a script Powershell to create a similar structure to that of a company<!--more-->, allowing me to automatically create OUs, users, groups, computers, from a CSV file.</p>
...
<img src="{{ site.baseurl }}/assets/images/Posts/2019-06-02-create-fakecompany/FakeCompany_Schema.jpg" class="align-center">
